...
class DiffusionPolicy(PreTrainedPolicy):
    ...
    def predict_action_chunk(
        ...
        Extra kwargs (e.g. sa_noise_ratio) are forwarded to
        diffusion.generate_actions for partial denoising from guided noise.
        """
        ...
        actions = self.diffusion.generate_actions(batch, noise=noise, **kwargs)
        return actions
